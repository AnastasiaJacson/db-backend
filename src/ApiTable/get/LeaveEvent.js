...
--            ev.inspector_id,
           i.full_name    as "inspector_full_name",
           i.dob          as "inspector_dob",
           i.phone_number as "inspector_phone_number",
...
--            b.status       as "bed_status",
    ...
    FROM act.leave ev
             ...
             INNER JOIN person.inspector i USING (inspector_id)
...
export const LeaveEventHandler = async (opts) => {
    return {
